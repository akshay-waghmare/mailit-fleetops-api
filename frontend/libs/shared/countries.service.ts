...
export class CountriesService {
  ...
  getPopularCountries(): Country[] {
    const popularCodes = ['US', 'CA', 'GB', 'AU', 'DE', 'FR', 'IT', 'ES', 'NL', 'BE', 'SE', 'NO', 'DK', 'CH', 'AT', 'IN', 'CN', 'JP', 'KR', 'SG', 'MY', 'TH', 'ID', 'PH', 'VN', 'BR', 'MX', 'AR', 'CL', 'ZA', 'NG', 'EG', 'MA', 'AE', 'SA'];
    return popularCodes.map(code => this.countries.find(c => c.code === code)!).filter(Boolean);
  }

  sortCountriesAlphabetically(): Country[] {
